        ...
        checkbox1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkbox1.isChecked()) {
                    Toast.makeText(MainActivity.this, "Sports selected", Toast.LENGTH_SHORT).show();
                }
            }
        });
        checkbox2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(checkbox2.isChecked()){
                    Toast.makeText(MainActivity.this, "Art selected", Toast.LENGTH_SHORT).show();
                }
            }
        });
        checkbox3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(checkbox3.isChecked()){
                    Toast.makeText(MainActivity.this, "Social Work selected", Toast.LENGTH_SHORT).show();
                }
            }
        });
